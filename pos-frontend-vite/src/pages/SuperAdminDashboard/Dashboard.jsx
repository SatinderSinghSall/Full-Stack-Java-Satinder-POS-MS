...
export default function Dashboard() {
  ...
  const pieData = storeStatusDistribution
    ? [
        {
          name: "Active",
          value: storeStatusDistribution.active,
          color: COLORS[0],
        },
        {
          name: "Pending",
          value: storeStatusDistribution.pending,
          color: COLORS[1],
        },
        {
          name: "Blocked",
          value: storeStatusDistribution.blocked,
          color: COLORS[2],
        },
      ]
    : [];
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-center gap-4 p-4 border rounded-lg">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">
                  New store "Zosh Mart" registered
                </p>
            ...
            <div className="flex items-center gap-4 p-4 border rounded-lg">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">
                  Store "ABC Supermarket" pending approval
                </p>
            ...
            <div className="flex items-center gap-4 p-4 border rounded-lg">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">
                  Store "XYZ Store" blocked for policy violation
                </p>
