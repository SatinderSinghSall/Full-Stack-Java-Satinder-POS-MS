        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mb-4 text-muted-foreground max-w-md">
              Empowering retailers with smart point-of-sale solutions that
              streamline operations, boost sales, and enhance customer
              experiences.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-foreground font-medium text-lg mb-4">
              Quick Links
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="text-muted-foreground">
                ...
                <p>Bangalore, Karnataka, India 560066</p>
              </li>
              <li className="text-muted-foreground">
                <p>+91 98765 43210</p>
              </li>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="md:flex md:items-center md:justify-between">
            <div className="text-sm text-muted-foreground">
              <p>&copy; {currentYear} Satinder POS-MS. All rights reserved.</p>
            </div>
